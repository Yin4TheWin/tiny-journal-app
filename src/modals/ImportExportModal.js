        ...
        {isImporting ? (
          ...
          <Container fluid>
            ...
            <Row className="align-items-center mb-4">
              ...
              <Col xs={4}>
                <Button variant="outline-danger" className="w-100" onClick={importReplace} disabled={isImporting}><FontAwesomeIcon icon={faDownload} /> Import (Replace)</Button>
              </Col>
            </Row>
            ...
            <Row className="align-items-center">
              ...
              <Col xs={4}>
                <Button variant="outline-success" className="w-100" onClick={importMerge} disabled={isImporting}><FontAwesomeIcon icon={faDownload} /> Import (Merge)</Button>
              </Col>
            </Row>
          </Container>
        )}
